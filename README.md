...
Example scripts are provided for OpenFOAM simulations, training and inference.

Detailed instructions on how to run each stage using the supplied containers are provided [here](./containers/README.md).
