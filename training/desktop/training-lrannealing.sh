...
cfdpinn \
    --debug \
    --tensorboard \
    --tensorboard-path $CFDPINN_ROOT/tboard/lrannealing/ \
    --case-type cavity \
    ...
    --adaption lrannealing \
    --prediction-animation

mv $CFDPINN_ROOT/animations/tmp_pred.mp4 $CFDPINN_ROOT/animations/tmp_pred_lrannealing.mp4